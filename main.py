...
def getRandomFortune():
    fortunes = ["I see much code in your future", "Consider eating more fortune cookies", "You will free the python"]
...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        number_sentence = 'Your Lucky Numbers Are: ' + lucky_number
